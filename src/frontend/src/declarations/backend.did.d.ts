...
export type Category = { 'locksmith' : null } |
  { 'cleaning' : null } |
  { 'other' : null } |
  { 'hvac' : null } |
  { 'plumbing' : null } |
...
export interface _SERVICE {
  ...
  'getListings' : ActorMethod<[[] | [Filter]], Array<ListingData>>,
  'getMessages' : ActorMethod<[Principal], Array<MessageData>>,
  'getRatingsByListing' : ActorMethod<[bigint], Array<RatingData>>,
