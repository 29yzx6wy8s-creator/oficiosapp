...
import type { Category as _Category, ExternalBlob as _ExternalBlob, Filter as _Filter, ListingData as _ListingData, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createListing(arg0: string, arg1: string, arg2: Category, arg3: string, arg4: string, arg5: string, arg6: bigint, arg7: string, arg8: Array<ExternalBlob>, arg9: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createListing(arg0, arg1, to_candid_Category_n10(this._uploadFile, this._downloadFile, arg2), arg3, arg4, arg5, arg6, arg7, await to_candid_vec_n12(this._uploadFile, this._downloadFile, arg8), arg9);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getListings(arg0: Filter | null): Promise<Array<ListingData>> {
        if (this.processError) {
            try {
                const result = await this.actor.getListings(to_candid_opt_n17(this._uploadFile, this._downloadFile, arg0));
    ...
    async getMessages(arg0: Principal): Promise<Array<MessageData>> {
        if (this.processError) {
            try {
    ...
    async getRatingsByListing(arg0: bigint): Promise<Array<RatingData>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRatingsByListing(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateListing(arg0: bigint, arg1: string, arg2: string, arg3: Category, arg4: string, arg5: string, arg6: string, arg7: bigint, arg8: string, arg9: Array<ExternalBlob>, arg10: string, arg11: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateListing(arg0, arg1, arg2, to_candid_Category_n10(this._uploadFile, this._downloadFile, arg3), arg4, arg5, arg6, arg7, arg8, await to_candid_vec_n12(this._uploadFile, this._downloadFile, arg9), arg10, arg11);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_ListingData_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ListingData): Promise<ListingData> {
...
async function from_candid_record_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    category: _Category;
    price: string;
    additionalImageIds: Array<_ExternalBlob>;
}): Promise<{
    id: bigint;
    title: string;
    active: boolean;
    ...
    return {
        ...
        price: value.price,
        additionalImageIds: await from_candid_vec_n25(_uploadFile, _downloadFile, value.additionalImageIds)
    };
}
...
function from_candid_variant_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "locksmith" in value ? Category.locksmith : "cleaning" in value ? Category.cleaning : "other" in value ? Category.other : "hvac" in value ? Category.hvac : "plumbing" in value ? Category.plumbing : "painting" in value ? Category.painting : "electricity" in value ? Category.electricity : "gardening" in value ? Category.gardening : "renovations" in value ? Category.renovations : "moving" in value ? Category.moving : "carpentry" in value ? Category.carpentry : "masonry" in value ? Category.masonry : value;
}
async function from_candid_vec_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ListingData>): Promise<Array<ListingData>> {
    return await Promise.all(value.map(async (x)=>await from_candid_ListingData_n21(_uploadFile, _downloadFile, x)));
}
...
function to_candid_Filter_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Filter): _Filter {
...
function to_candid_opt_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Filter | null): [] | [_Filter] {
    return value === null ? candid_none() : candid_some(to_candid_Filter_n18(_uploadFile, _downloadFile, value));
}
...
function to_candid_variant_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Category): {
    ...
    return value == Category.locksmith ? {
        locksmith: null
        ...
        electricity: null
    } : value == Category.gardening ? {
        gardening: null
    } : value == Category.renovations ? {
        renovations: null
    } : value == Category.moving ? {
        moving: null
    } : value == Category.carpentry ? {
        carpentry: null
    } : value == Category.masonry ? {
        masonry: null
    } : value;
}
